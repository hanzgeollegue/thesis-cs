...
def ranking_view(request):
    ...
    try:
        ...
        for resume_data in resumes_data:
            ...
            # Get the filename from the batch info
            filename = resume_data.get('meta', {}).get('source_file', 'Unknown')
            ...
            if ranking_info:
                ranking_display['ranking_score'] = ranking_info.get('scores_snapshot', {}).get('tfidf_section', 0)
